                ...
                <div class="panel-content">              
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <!--  <input type="text" data-mask="999999999999" class="form-control" placeholder="IMEI" name="imei">-->
                      <!--</div>                    -->
                      <div class="form-group">
                        <label class="form-label">Chasis Number</label>
                        <input type="text"  class="form-control" placeholder="Enter Chasis serial" name="serial_chasis">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label clas="form-label">Plate Number</label>
